      ...
      <section id="tiers" className="py-20 lg:py-28">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-center text-[14px] text-white/55 mt-10 max-w-2xl mx-auto leading-relaxed">
            ...
            Engine with Quick + Think-Deeper modes), live FX conversion across
            5 currencies, and exportable GAAP-compliant outputs. Upgrade or
            cancel anytime.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white/[0.02] border border-white/8 rounded-2xl p-6">
              ...
              <p className="text-[14px] text-white/65 leading-relaxed">
                ...
                Think-Deeper routes to the Strategist with extended reasoning,
                streaming the chain of thought live. Use the right one for
                the question.
              </p>
            </div>
            <div className="bg-white/[0.02] border border-white/8 rounded-2xl p-6">
