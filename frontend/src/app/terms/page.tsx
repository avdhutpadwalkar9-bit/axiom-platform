  ...
  const sections = [
    {
      ...
      content: "By accessing or using the Axiom platform, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using the platform. These terms apply to all users, including individual users, businesses, and enterprise clients. Axiom reserves the right to update these terms at any time, and continued use of the platform constitutes acceptance of any modifications."
    },
    {
      title: "2. Use of Service",
      content: "Axiom provides AI-powered financial analysis, scenario modeling, and reporting tools. You may use the platform only for lawful purposes and in accordance with these terms. You agree not to use the platform to upload fraudulent financial data, attempt to reverse-engineer our AI models, or resell access without authorization. You are responsible for maintaining the confidentiality of your account credentials. Axiom is a decision-support tool and does not constitute financial, legal, or tax advice."
    },
    {
    ...
    },
    {
      ...
      content: "The Axiom platform, including its software, AI models, algorithms, designs, documentation, and branding, is the exclusive property of Axiom Financial Intelligence Pvt. Ltd. You retain full ownership of all financial data you upload to the platform. Insights, reports, and analyses generated by Axiom based on your data are licensed to you for your internal business use. You may not copy, modify, distribute, or create derivative works of any part of the platform without prior written consent."
    },
    {
    ...
    },
    {
      ...
      content: "Axiom provides the platform on an \"as is\" and \"as available\" basis. We do not guarantee that the platform will be uninterrupted, error-free, or that any financial analysis will be complete or accurate in all cases. To the maximum extent permitted by law, Axiom shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including loss of profits, data, or business opportunities. Our total liability for any claim shall not exceed the amount you paid for the platform in the 12 months preceding the claim."
    },
    {
      title: "7. Termination",
    ...
    {
      title: "9. Contact",
      content: "For questions about these Terms of Service, contact us at legal@axiom.finance or write to: Axiom Financial Intelligence Pvt. Ltd., WeWork Embassy Golf Links, Bangalore, Karnataka 560071, India."
    },
  ];
    ...
    <div className="min-h-screen bg-[#faf9f7] text-[#1a1a1a] overflow-hidden">
      ...
      <section className="py-20 px-8">
        <div className="max-w-[760px] mx-auto">
          <p className="text-[16px] text-[#666] leading-[1.8] mb-12">
            Please read these Terms of Service carefully before using the Axiom platform.
            These terms govern your access to and use of Axiom and all related services
            provided by Axiom Financial Intelligence Pvt. Ltd.
          </p>
      ...
      <section className="py-16 px-8 bg-[#f5f4f2] border-t border-[#eee]">
        <div className="max-w-[760px] mx-auto flex flex-col sm:flex-row items-center justify-center gap-6">
          <Link href="/privacy" className="text-[14px] text-[#666] hover:text-[#1a1a1a] transition-colors font-medium underline underline-offset-4">
            Privacy Policy
          </Link>
