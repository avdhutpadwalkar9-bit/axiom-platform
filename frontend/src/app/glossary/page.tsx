...
const glossaryTerms = [
  ...
  { term: "GST (Goods & Services Tax)", def: "India's unified indirect tax. Businesses must track input tax credit (ITC) and output tax to determine net GST liability." },
  { term: "Ind AS 12 (Income Taxes)", def: "Standard for income tax accounting. Requires recognition of deferred tax assets and liabilities from temporary differences." },
  { term: "Ind AS 16 (Property, Plant & Equipment)", def: "Standard for fixed asset accounting including recognition, measurement, depreciation, and derecognition." },
  { term: "Ind AS 24 (Related Party Disclosures)", def: "Requires disclosure of transactions between the entity and related parties (directors, key management, subsidiaries)." },
  { term: "Ind AS 37 (Provisions & Contingencies)", def: "Standard for recognizing provisions, contingent liabilities, and contingent assets when there is a present obligation." },
  { term: "Ind AS 115 (Revenue Recognition)", def: "Five-step model: identify contract, identify performance obligations, determine price, allocate price, recognize when satisfied." },
